...
The dataset comprises document images from 58 different manuscripts provided by Judith Olszowy-Schlanger. The images exhibit heterogeneity in terms of layout, resolution, brightness, and contrast. 

![Figure 1](readme_images/heteregenous.png)

# Description of each file and folder included in this repository.

- **ASC_dataset**: This folder contains 206 images sourced from 58 manuscripts. Each manuscript contributes 4 pages, and the images are named sequentially following the "manuscriptname_pagename" convention.
